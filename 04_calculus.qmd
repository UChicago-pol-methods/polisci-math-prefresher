...
```{r, derivsimple, echo = FALSE, fig.cap="The Derivative as a Slope", warning=FALSE}
...
1. log prime x is one over x: $\frac{d}{dx} \log x = \frac{1}{x}$ (@fig-derivlog)
